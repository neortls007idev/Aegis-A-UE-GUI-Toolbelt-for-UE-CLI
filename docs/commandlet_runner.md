...
2. **Commandlet & Scope**
   - Dropdown of common commandlets (ResavePackages, FixupRedirects, AssetAudit, SizeMap, GatherText) with project-specific additions stored in `<uproject>/.aegies/commandlets.json` via an **Add…** button.
